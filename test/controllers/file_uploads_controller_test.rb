...
class FileUploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create file_upload" do
    assert_difference("FileUpload.count") do
      post file_uploads_url, params: { file_upload: { description: @file_upload.description, title: @file_upload.title, user_id: @file_upload.user_id } }
    end
  ...
  test "should update file_upload" do
    patch file_upload_url(@file_upload), params: { file_upload: { description: @file_upload.description, title: @file_upload.title, user_id: @file_upload.user_id } }
